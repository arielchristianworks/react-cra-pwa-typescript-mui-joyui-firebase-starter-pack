      ...
      <Container fixed sx={{ height: 'inherit', width: 'inherit'}}>
        <Stack justifyContent="center" alignItems="center" sx={{ height: '100%', width: '100%'}}>
          <Stack spacing={0} justifyContent="center" alignItems="center">
            <Typography level="h4" fontWeight="bold" textAlign='center'>{mock404.header}</Typography>
            ...
            <Box sx={{ mb: 3, maxWidth: 600, px: 2 }}>
              <Typography level="body-md" fontWeight="bold" textAlign="center">{mock404.subheader}</Typography>
            </Box>
            
            <Stack direction="row" spacing={2} justifyContent="center" alignItems="center">
              <Button size="sm" variant="solid" onClick={handleBackToHome} >{'BACK TO HOME'}</Button>
